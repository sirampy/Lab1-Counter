...
extern const VlUnpacked<CData/*7:0*/, 1024> Vcounter__ConstPool__TABLE_h50d04bae_0;
...
VL_INLINE_OPT void Vcounter___024root___sequent__TOP__0(Vcounter___024root* vlSelf) {
    ...
    // Body
    __Vtableidx1 = (((IData)(vlSelf->en) << 9U) | (
                                                   ((IData)(vlSelf->count) 
                                                    << 1U) 
                                                   | (IData)(vlSelf->rst)));
    vlSelf->count = Vcounter__ConstPool__TABLE_h50d04bae_0
        [__Vtableidx1];
}
